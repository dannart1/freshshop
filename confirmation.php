...
<div class="container">
    <div class="jumbotron" style="margin-top: 30px; background-color: #E0E0E0;">
        <img class="logo img-responsive" src="http://jose-aguilar.com/modulos-prestashop/themes/japs/img/logo.png" alt="Jose Aguilar - M�dulos PrestaShop" height="65" width="300">
