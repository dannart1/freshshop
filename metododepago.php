...
if (isset($_POST['submitPayment'])) {
    ...
    <gif src="images/ajax-loader.gif" alt="loader">
...
?>
<form class="form-amount" action="metododepago.php" method="post">
    <?php if ($error) { ?><div class="alert alert-danger">El valor introducido no es correcto. Debe introducir por ejemplo: $50.000</div><?php } ?>
    ...
    <div class="form-group">
        ...
        <input type="text" id="amount" name="amount" class="form-control"<?php if ($amount) { ?> value="<?php echo $amount; ?>"<?php }else{ ?> placeholder="Por ejemplo: $5"<?php } ?>>
    </div>
    <input class="btn btn-lg btn-primary btn-block" name="submitPayment" type="submit" value="Pagar">
    <img class="img-responsive" src="images/paypal.png" alt="Pagos con PayPal y PHP" height="65" width="300"><br/>
</form> 
<?php
}
?>
